...
- **智能分流规则**：基于 [Loyalsoldier/clash-rules](https://github.com/Loyalsoldier/clash-rules)（⭐ ~27.6k），每日自动更新，精确国内外分流
...
- **BBR 拥塞控制** + `fq` 队列调度
- **TCP 缓冲区**：动态计算，8MB 上限（适配 1GB 内存服务器）
